        ...
        <div class="content">
                        ...
                        <div class="col-md-8">
                            <div class="page-title-box">
                                ...
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item">
                                        <a href="{{ route('admin.trainings.index') }}">Training Gallery</a>
                                    </li>
                                    <li class="breadcrumb-item active">Edit Training Gallery</li>
                                </ol>
                            </div>
                        </div>
            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            <form action="{{ route('admin.training.update', ['training' => $training->id]) }}"
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group col-md-12">
                                            <label for="parent_id">Training Gallery Image *</label>
                                            <div class="col-lg-12">
