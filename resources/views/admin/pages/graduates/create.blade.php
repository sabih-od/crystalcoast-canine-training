                        ...
                        <div class="col-md-8">
                            <div class="page-title-box">
                                ...
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item">
                                        <a href="{{ route('admin.graduates.index') }}">Graduate Galleries</a>
                                    </li>
                                    <li class="breadcrumb-item active">Create Graduate Gallery</li>
                                </ol>
                            </div>
                        </div>
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <h4 class="mt-0 header-title">Create Graduate Gallery</h4>

                                <form method="POST" action="{{ route('admin.graduate.store') }}"
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group col-md-12">
                                                <label for="name">Graduate Gallery Image *</label>
                                                <div class="col-lg-12">
