        ...
        <div class="content">
                        ...
                        <div class="col-md-8">
                            <div class="page-title-box">
                                ...
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item">
                                        <a href="{{ route('admin.trainingContents.index') }}">Training </a>
                                    </li>
            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            <form action="{{ route('admin.trainingContent.update', ['training' => $training->id]) }}"
                                            ...
                                            <div class="row">
                                                <div class="col-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" name="title" id="title" class="form-control"
                                                            value="{{ old('short_description', $training->title ?? '') }}">
                                                        @error('title')
                                                ...
                                                <div class="col-6">
                                                    <div class="form-group">
                                                        ...
                                                        style="width: 100%; height: 300px;">{{ old('description', $training->description ?? '') }}</textarea>
                                                        @error('title')
                                                            <span class="text-danger">{{ $message }}</span>
                                                        @enderror
                                                    </div>
                                                ...
                                                <div class="panel panel-body">
                                                    <div id="crop-image"
                                                        ...
                                                        <img id="image-preview"
                                                            src="{{ $training->trainingImage('training_img') }}"
                                                            alt="Image Preview"
