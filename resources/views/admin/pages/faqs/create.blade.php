    ...
    <div class="content-page">
        ...
        <div class="content">
            <div class="container-fluid">
                ...
                <!-- end page-title -->
                <form id="add-product-form" action="{{ route('admin.faq.store') }}" method="POST"
                        ...
                        <div class="col-lg-12">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <h4 class="mt-0 header-title">Create Faq</h4>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div>
                                            <textarea class="form-control" name="description" id="description" placeholder="{{ __('Description') }}" id="description"
